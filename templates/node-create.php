	...
	<form method="post" id="node_form" action="/node/create/<?= $book_hid; ?>">
		...
		<div class="span3">
			...
			<div class="row">
				...
				<input type="text" class="input-block-level" data-counter="counter-title" name="title" id="title" maxlength="256">
			...
			<div class="row">
				...
				<input type="text" class="input-block-level" data-counter="counter-slug" name="slug" id="slug" maxlength="64">
		...
		<div class="span8">
			<div id="alerts"></div>
				...
				<div id="node_content" class="node_content"><? if (isset($node_content)) echo htmlspecialchars_decode($node_content); ?></div>
